...
int main(int argc, char **argv)
{
  ...
  std::string qdepth_str("--queue-depth=100");
  char *qdepth= new char[qdepth_str.length()+1];
  strcpy(qdepth, qdepth_str.c_str());

  char **dbplugin_argv= new char*[4];
  dbplugin_argv[0]= argv[0];
  dbplugin_argv[1]= dbplugin;
  dbplugin_argv[2]= querylog;
  dbplugin_argv[3]= qdepth;
