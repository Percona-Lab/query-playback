===================================
 Installing Playback from Binaries
===================================

Before installing, you might want to read the :doc:`release-notes`.

Ready-to-use binaries are available from the *Playback* `download page <http://www.percona.com/downloads/Percona-Playback/>`_, including:
