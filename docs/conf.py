# -*- coding: utf-8 -*-
#
# Percona playback documentation build configuration file, created by
...
project = u'Percona Playback'
copyright = u'2011-2013 Percona Ireland Ltd'
...
extlinks = {'bug': ('https://bugs.launchpad.net/percona-playback/+bug/%s',
                      '#')}
...
html_title = 'Percona Playback Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Percona Playback Docs'
...
htmlhelp_basename = 'PerconaPlayback'
...
latex_documents = [
  ('index', 'PerconaPlayback.tex', u'Percona Playback',
...
man_pages = [
#    ('index', 'perconaplayback', u'Percona Playback',
#     [u'Percona Inc'], 1)
]
